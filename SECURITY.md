...
1. Navigate to [Report a Vulnerability](https://github.com/hyperpolymath/wsl-compute-governor-dispatcher/security/advisories/new)
...
- This repository (`hyperpolymath/wsl-compute-governor-dispatcher`) and all its code
...
- **GitHub Security Advisories**: Published at [Security Advisories](https://github.com/hyperpolymath/wsl-compute-governor-dispatcher/security/advisories)
...
When using Wsl Compute Governor Dispatcher, we recommend:
...
- [Security Advisories](https://github.com/hyperpolymath/wsl-compute-governor-dispatcher/security/advisories)
...
| Purpose | Contact |
|---------|---------|
| **Security issues** | [Report via GitHub](https://github.com/hyperpolymath/wsl-compute-governor-dispatcher/security/advisories/new) or j.d.a.jewell@open.ac.uk |
| **General questions** | [GitHub Discussions](https://github.com/hyperpolymath/wsl-compute-governor-dispatcher/discussions) |
...
*Thank you for helping keep Wsl Compute Governor Dispatcher and its users safe.* 🛡️
